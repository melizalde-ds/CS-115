/**
* File: LandscapeObject.java
* Description: Abstract class used as a superclass to all objects created for a landscape scene.
* Lessons Learned: How to us Graphics2D to draw shapes and use inheritance
