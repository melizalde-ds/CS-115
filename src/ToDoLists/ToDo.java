...
public abstract class ToDo implements Modifiable {
	 ...
	 * Automatically assigns the toDoID and increments the nextToDoID.
	 * 
	 * @param t The title of a ToDo list object. User created through a user
	 *          interface.
	 * @return void
	 */
	...
	/**
	 * Returns void.
	 * Modifies the value in a key/value pair by change amount for the associated
	 * key in a HashMap<String, Integer>.
	 *
	 * @param item   The key to the entry in HashMap(String, Integer) that needs to
	 *               be modified.
	...
	/**
	 * Returns void.
	 * Deletes the key/value pair indicated by the key in a HashMap<String,
	 * Integer>.
	 *
	 * @param item The key to the entry in the HashMap(String, Integer) that will be
	 *             deleted.
	 * @return void
	 */
